...
public class Player extends Character {
	...
	public Player(float x, float y) throws SlickException {
		...
		setMovingAnimation(new Image[]{new Image("data/img/characters/player/nerpina_1.png"),new Image("data/img/characters/player/nerpina_2.png"),
                new Image("data/img/characters/player/nerpina_3.png"),new Image("data/img/characters/player/nerpina_4.png")}
                ,125);
